<?php
	...
	if(isset($_SESSION['rental'])){
		foreach ($_SESSION['rental'] as $qty) {
			$rental += $qty;
		}
	}
...
<body>
	...
	<div class="info">
		<a href="view-rental.php">
			(<?php echo $rental ?>) books in your rental list
		</a>
	</div>
		...
		<ul class="books">
			<?php while ($row = mysqli_fetch_assoc($books)) : ?>
				<li>
					...
					<a href="add-to-rental.php?id=<?php echo $row['id'] ?>" class="add-to-rental">Add to Rental</a>
				</li>
			<?php endwhile; ?>
		</ul>
	</div>
